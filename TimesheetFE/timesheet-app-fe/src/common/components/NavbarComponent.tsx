  ...
  return (
    <header className="header">
			<div className="inner-wrap">
				...
				<img src="../../images/logo/logo-white.png" alt="Nema slike"/>
				</a>
				<nav className="navigation">
					...
					<ul className="navigation__menu">
						...
						<li className="navigation__list">
							<a href="clients" className="btn navigation__button navigation__button--active">Clients</a>
						</li>
						<li className="navigation__list">
							<a href="projects" className="btn navigation__button">Projects</a>
						</li>
						<li className="navigation__list">
							<a href="categories" className="btn navigation__button">Categories</a>
						</li>
						<li className="navigation__list">
